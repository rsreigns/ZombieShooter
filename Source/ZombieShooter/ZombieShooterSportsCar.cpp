...
#include "ZombieShooterSportsCar.h"
#include "ZombieShooterSportsWheelFront.h"
#include "ZombieShooterSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AZombieShooterSportsCar::AZombieShooterSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UZombieShooterSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UZombieShooterSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UZombieShooterSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UZombieShooterSportsWheelRear::StaticClass();
