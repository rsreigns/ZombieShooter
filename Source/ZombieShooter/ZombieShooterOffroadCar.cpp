...
#include "ZombieShooterOffroadCar.h"
#include "ZombieShooterOffroadWheelFront.h"
#include "ZombieShooterOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

AZombieShooterOffroadCar::AZombieShooterOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UZombieShooterOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UZombieShooterOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UZombieShooterOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UZombieShooterOffroadWheelRear::StaticClass();
